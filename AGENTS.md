...
compatible with the Boost Software License, GPLv3+ or LGPLv2.1+ license,
or may introduce conflicting license terms if they include code from other
projects.
...
Boost Software License, GPLv3+ or LGPLv2.1+ licenses.
